            ...
            <TableBody>
                ...
                >
                    ...
                    <TableCell align="center">
                        ...
                        <LoadingButton loading={loading} onClick={() => handleDeleteItem(item.productId)} color='error'>
                            <Remove></Remove>
                        </LoadingButton>
                    ...
                    <TableCell align="right">${((item.price/100) * item.quantityInCart).toFixed(2)}</TableCell>
                    <TableCell align="right">
                        <LoadingButton loading={loading} onClick={() => handleDeleteItem(item.productId,item.quantityInCart)} color='error'>
                            <Delete></Delete>
                        </LoadingButton>
                    </TableCell>
                </TableRow>
